...
// Hardcoded fallback — synced with BTCL API on 2026-06-10
// displayName overrides the Forename+Surname concat for players whose BTCL names are swapped/full-formal
const BTCL_FALLBACK = [
  ...
  // BTCL swapped Forename/Surname — displayName keeps familiar order; statName matches stats-2026.json
  ...
  // BTCL swapped to Daniel Krishen — displayName + statName restore correct order
  ...
  // BTCL now lists as Daniel / Anthony Shenal — displayName + statName restore correct order
  ...
  { PlayerID: 6631, Forename: 'Thevakumar',     Surname: 'Kanagarathinam Anton', AgeGroup: 'Pro', BatStyle: 'Right Hand', BowlStyle: 'Right-arm fast',         Photo: '6631.jpeg',                                        player_type: 'Home',           statName: 'Thevakumar Kanagarathinam Anton' },
  // BTCL uses full Sinhala formal name — displayName shows familiar short name
  { PlayerID: 7348, Forename: 'KORALAGAMAGE DON MALINDU', Surname: 'MADURANGA', AgeGroup: 'Pro', BatStyle: 'Right Hand', BowlStyle: 'Off break (right-arm)',   Photo: '7348.jpeg',                                        player_type: 'Overseas Player', displayName: 'Malindu Maduranga', statName: null },
  ...
  // 7358 Arivu Sasikumar removed from BTCL squad 2026-06-10
  ...
  // New player added to BTCL squad 2026-06-10
  { PlayerID: 7570, Forename: 'Viknarajah',     Surname: 'Logeshwaran',   AgeGroup: 'Pro',      BatStyle: 'Right Hand', BowlStyle: 'Right-arm fast',           Photo: '7570.jpeg',                                        player_type: 'Home Player' },
]
