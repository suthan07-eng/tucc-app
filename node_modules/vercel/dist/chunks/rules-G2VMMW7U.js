...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-DXRXKG6Q.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-DXRXKG6Q.js")).default(client, args);
    case "add":
      return (await import("./add-FEHGU5ZE.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-EECXOMPN.js")).default(client, args);
    case "rm":
      return (await import("./rm-GNY6PA2Z.js")).default(client, args);
    case "update":
      return (await import("./update-GSE7WNBV.js")).default(client, args);
    default:
