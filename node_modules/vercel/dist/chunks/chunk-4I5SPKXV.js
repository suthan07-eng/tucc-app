...
import {
  routesCommand
} from "./chunk-U5GMPX5T.js";
import {
  metricsCommand
} from "./chunk-2GC2GW2H.js";
import {
  devCommand
} from "./chunk-NQQWZYTY.js";
import {
  activityCommand
} from "./chunk-Q5MHVELE.js";
import {
  alertsCommand
} from "./chunk-MWQHQ7FW.js";
import {
  listCommand
} from "./chunk-S6EMI466.js";
import {
  buildCommand,
  pullCommand
} from "./chunk-OLJ6HISC.js";
import {
  envCommand
} from "./chunk-KAC4IO5S.js";
import {
  confirmOption,
  forceOption,
  formatOption,
...
var listSubcommand4 = {
  name: "list",
  aliases: ["ls"],
  description: "List Connex connectors linked to the current project (falls back to every connector in the team when no project is linked or when --all-projects is set)",
  arguments: [],
  options: [
    {
      name: "all-projects",
      ...
      type: Boolean,
      deprecated: false,
      description: "List every Connex connector in the team, regardless of project link"
    },
    {
      name: "limit",
      shorthand: null,
...
var tokenSubcommand = {
  name: "token",
  aliases: [],
  description: "Get a token for a Connex connector (accepts a connector ID like scl_abc or a UID like slack/my-bot)",
  arguments: [
    {
      name: "id",
      required: true
...
var attachSubcommand = {
  name: "attach",
  aliases: [],
  description: "Attach a Vercel project to a Connex connector for one or more environments",
  arguments: [
    {
      name: "client",
      required: true
